...
function buildDoc(done) {
  ...
  docco.document({
    ...
    args: sources
      ...
      .pipe($.replace('<div id="jump_page">', '<div id="jump_page"><a class="source" href="../base.html">&lt;&lt;&lt; back to documentation</a>'))
...
function writeVersion() {
  return gulp.src(['base.html', 'doc/download.html', 'README.md'], { base: "./" })
